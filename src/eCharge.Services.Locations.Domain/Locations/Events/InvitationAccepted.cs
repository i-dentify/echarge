...
// <copyright file="InvitationAccepted.cs" company="i-dentify Software Development">
...
namespace ECharge.Services.Locations.Domain.Locations.Events
{
    ...
    [EventVersion("InvitationAccepted", 1)]
    public class InvitationAccepted : AggregateEvent<Location, LocationId>
    {
        #region [ Constructor ]
