...
namespace ECharge.Services.Locations.Domain.Locations.Commands
{
    ...
    public class AddLocation : Command<Location, LocationId>
    {
        #region [ Constructor ]

        public AddLocation(LocationId aggregateId, string name, string address, Latitude latitude, Longitude longitude,
