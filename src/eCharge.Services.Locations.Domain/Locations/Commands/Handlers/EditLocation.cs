...
namespace ECharge.Services.Locations.Domain.Locations.Commands.Handlers
{
    ...
    public class EditLocation : CommandHandler<Location, LocationId, Commands.EditLocation>
    {
        ...
        public override Task ExecuteAsync(Location aggregate, Commands.EditLocation command,
            CancellationToken cancellationToken)
        {
            aggregate.Edit(command.Name, command.Address, command.Latitude, command.Longitude, command.PricePerKw,
