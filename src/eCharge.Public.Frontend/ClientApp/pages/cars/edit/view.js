...
function view({ state }) {
    ...
    return [
        m('h1', i18next.t('car:EditCar_Name', {
            name: car().name,
        })),
        m('form.horizontal', {
            onsubmit: (event) => {
            ...
            m('fieldset', [
                ...
                m('div.form-group', [
                    ...
                    m('div', [
                        m('input#batteryCapacity.form-control[type=number][min=0][step=any][aria-labelledby=batteryCapacity__label]', {
                            class: classnames({
