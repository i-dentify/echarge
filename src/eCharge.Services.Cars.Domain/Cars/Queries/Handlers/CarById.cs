...
namespace ECharge.Services.Cars.Domain.Cars.Queries.Handlers
{
    ...
    public class CarById : IQueryHandler<Queries.CarById, Car>
    {
        #region [ Constructor ]

        public CarById(IMapper mapper, CurrentUserProvider currentUserProvider,
        ...
        public async Task<Car> ExecuteQueryAsync(Queries.CarById query, CancellationToken cancellationToken)
        {
