...
namespace ECharge.Services.Cars.Domain.Cars.Queries.Handlers
{
    ...
    public class CarsByIds : IQueryHandler<Queries.CarsByIds, IReadOnlyCollection<Car>>
    {
        #region [ Constructor ]

        public CarsByIds(IMapper mapper, CurrentUserProvider currentUserProvider,
        ...
        public async Task<IReadOnlyCollection<Car>> ExecuteQueryAsync(Queries.CarsByIds query,
